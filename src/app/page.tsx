...
export default function Home() {
  ...
  const audio =
    typeof Audio !== "undefined" ? new Audio("/sounds/gaddamn.mp3") : null;
...
return (
  <>
    ...
    <div className="min-h-screen flex flex-col items-center justify-center p-8 relative overflow-hidden">
      ...
      <button
        onClick={goToLogin}
        className="bg-red-500 hover:bg-red-300 text-white font-bold py-2 px-6 rounded mb-6"
      >
        Login
      </button>
      <button
